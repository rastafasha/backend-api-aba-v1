...
class PatientResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            "parent_address" => $this->resource->parent_address,
            "parent_city" => $this->resource->parent_city,
            "parent_state" => $this->resource->parent_state,
            "parent_zip" => $this->resource->parent_zip,
            ...
            "auto_accident" => $this->resource->auto_accident,
            "other_accident" => $this->resource->other_accident,
            ...
            "referring_provider_first_name" => $this->resource->referring_provider_first_name,
            "referring_provider_last_name" => $this->resource->referring_provider_last_name,
            "referring_provider_npi" => $this->resource->referring_provider_npi,
            ...
            'locals' => [
                ...
                "phone1" => $this->resource->location->phone1,
