        ...
        return response()->json([
            ...
            "specialists" => $specialists->map(function ($specialist) {
                return[
                                ...
                                "contract_type" => $specialist->contract_type,
                                "languages" => $specialist->languages,
                                "birth_date" => $specialist->birth_date,
                                "note" => $specialist->note,
                                "schedule" => $specialist->schedule,
                                "medicaid_provider" => $specialist->medicaid_provider,
                                "school_badge" => $specialist->school_badge,
