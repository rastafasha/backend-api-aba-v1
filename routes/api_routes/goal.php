...
// /{patient_id}
Route::get('goal/show/goalsmaladaptives/{maladaptive}/{patient_identifier}', [ReductionGoalController::class, 'goals.showGoalsbyMaladaptive'])->name('goals.showGoalsbyMaladaptive');
