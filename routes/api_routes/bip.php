...
Route::get('bip/profile/{patient_identifier}', [BipController::class, 'showProfile'])->name('showProfile');
Route::get('bip/profileBip/{patient_identifier}', [BipController::class, 'showBipPatientIdProfile'])->name('showBipPatientIdProfile');
Route::get('bip/profileBipPdf/{patient_identifier}', [BipController::class, 'showBipPatientIdProfilePdf'])->name('showBipPatientIdProfile');
Route::post('bip/store', [BipController::class, 'store'])->name('store');
Route::put('bip/update/{id}', [BipController::class, 'update'])->name('update');

Route::get('bip/show/byuser/{patient_identifier}', [BipController::class, 'showbyUser'])->name('showbyUser');
